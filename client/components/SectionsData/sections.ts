...
export const education: ContainerItemProps = {
  ...
  title: "Education",
  description:
    "I have both my bachelors and masters degrees in computer science from the Stevens Institute of Technology. I worked as a TA in my CS 496: Programming Languages and CS 511: Concurrent Programming classes.",
};
export const work_done: ContainerItemProps = {
  id: "work-done",
  title: "Portfolio Work",
  description: "I've worked on a wide variety of programming ",
};
