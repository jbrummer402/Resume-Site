      ...
      <div>
        ...
        >
          ...
          <Nav style={{ fontSize: "2.3rem" }} className="mr-auto">
            ...
            <Nav.Link style={{ padding: "2rem" }} href="/Projects">
              Resume and Skills
            </Nav.Link>
            ...
            {home ? (
              <>
                ...
                >
                  ...
                  <p>
                    I made this site completely on my own using React and
                    Next.js for the front end. I followed the next js tutorial
                    here as a reference and then added my own content.
                  </p>
                  <p>
                    I have yet to finish the backend for it, but be on the
                    lookout
                  </p>
                  <p>
                  ...
                  <p>
                    This site may change in appearance or function as time goes
                    on as I learn new things, so be prepared
                  </p>
                </section>
                <section
